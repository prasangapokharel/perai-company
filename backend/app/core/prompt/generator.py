...
from app.core.prompt.template_generator import PromptTemplateGenerator, ToneEnum, LanguageEnum
...
(You are responding in Nepali. Provide clear and grammatically correct responses.)""",
    ...
    @staticmethod
    def formatResponseByLanguage(response: str, language: str) -> dict:
    ...
    def getSettingsSummary(company_settings: CompanySettings) -> dict:
        ...
        return {
            ...
            if company_settings.language == "english"
            else "नेपाली (Nepali)",
