...
class PromptTemplateGenerator:
    ...
    def __init__(self):
        ...
        # Template lives in core/finetune/prompts/ — resolve relative to core/
        core_dir = Path(__file__).resolve().parents[1]
        self.template_path = core_dir / "finetune" / "prompts" / "SystemPrompt.md"
    ...
    def generate_system_prompt(
        ...
        variables: Dict[str, str] = {
            ...
            if knowledge_block
            else "No specific knowledge base provided yet.",
    ...
    def get_available_tones(self) -> Dict[str, str]:
        ...
        return {tone.value: self.TONE_INSTRUCTIONS[tone]["tone_description"] for tone in ToneEnum}
