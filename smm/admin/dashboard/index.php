...
// Get pending tickets
$pendingTickets = $conn->query("SELECT COUNT(*) as count FROM support_tickets WHERE status = 'pending'")->fetch_assoc()['count'];
...
<div class="space-y-8">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
            ...
            <p class="text-slate-500 font-medium mt-1">System-wide performance and activity overview.</p>
        </div>
        <div class="flex gap-3">
            ...
            <a href="../orders/" class="inline-flex items-center px-6 py-3 bg-primary-600 text-white text-sm font-bold rounded-xl hover:bg-primary-700 shadow-lg shadow-primary-200 transition-all">
                Manage Orders
            </a>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm relative overflow-hidden group">
            ...
            <p class="text-3xl font-black text-slate-900 font-display"><?php echo number_format($totalUsers); ?></p>
        ...
        <div class="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm relative overflow-hidden group">
            ...
            <p class="text-3xl font-black text-slate-900 font-display"><?php echo number_format($totalOrders); ?></p>
        ...
        <div class="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm relative overflow-hidden group">
            ...
            <p class="text-3xl font-black text-primary-600 font-display"><?php echo formatCurrency($totalRevenue); ?></p>
            <div class="mt-4 flex items-center text-xs font-bold text-slate-400 bg-slate-50 w-fit px-2 py-1 rounded-xl">
                Completed orders
            </div>
        </div>
        ...
        <div class="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm relative overflow-hidden group">
            ...
            <p class="text-3xl font-black text-slate-900 font-display"><?php echo formatCurrency($totalFundsAdded); ?></p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
            <div class="p-8 border-b border-slate-50 flex justify-between items-center">
                ...
                <a href="../orders/" class="text-xs font-bold text-primary-600 hover:text-primary-700 uppercase tracking-widest">View All Orders</a>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-slate-50">
                            ...
                            <?php while ($order = $recentOrders->fetch_assoc()): ?>
                                <tr class="hover:bg-slate-50/50 transition-colors">
                                    <td class="px-8 py-5">
                                        ...
                                        <div class="text-[11px] text-slate-400 mt-0.5 truncate max-w-[180px] font-medium"><?php echo htmlspecialchars($order['service_name']); ?></div>
                                    </td>
                                    <td class="px-8 py-5">
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="4" class="px-8 py-10 text-center text-slate-400 font-medium font-display">No recent activity.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
        ...
        <div class="space-y-6">
            <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-8">
                ...
                <div class="space-y-3">
                    ...
                    <a href="../tickets.php" class="flex items-center justify-between p-4 rounded-2xl bg-slate-50 border border-slate-100 hover:border-primary-200 hover:bg-primary-50 transition-all group">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-xs font-black text-slate-900 uppercase tracking-tight">Support Desk</p>
                                <p class="text-[10px] font-bold text-slate-400 uppercase"><?php echo $pendingTickets; ?> Open Tickets</p>
                            </div>
                        </div>
                        <svg class="w-4 h-4 text-slate-300 group-hover:text-primary-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7" /></svg>
                    </a>
            ...
            <div class="bg-slate-900 rounded-3xl p-8 text-white relative overflow-hidden shadow-xl shadow-slate-200">
                ...
                <h3 class="text-sm font-black text-primary-400 uppercase tracking-widest mb-2 font-display">System Health</h3>
