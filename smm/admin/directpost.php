...
<?php if ($generation_attempted && $success && $message): ?>
    <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm mb-6">
        ...
        <div class="flex space-x-3">
            <a href="announcements.php" class="px-4 py-2 bg-primary-500 text-white rounded hover:bg-primary-600">
                View All Posts
            </a>
...
<?php if ($generation_attempted && !$success && $error): ?>
    <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm mb-6">
        ...
        <div class="flex space-x-3">
            ...
            <a href="postevent.php" class="px-4 py-2 bg-gray-500 text-white rounded hover:bg-gray-600">
                Manual Post
            </a>
        </div>
    </div>
...
<div class="bg-white p-8 rounded-xl border border-gray-200 shadow-sm">
    ...
    <div class="mt-6 flex justify-center space-x-3">
        <a href="announcements.php" class="px-4 py-2 border border-gray-300 rounded hover:bg-gray-50">
            View All Posts
        </a>
        <a href="postevent.php" class="px-4 py-2 border border-gray-300 rounded hover:bg-gray-50">
            Manual Post
        </a>
    </div>
</div>
