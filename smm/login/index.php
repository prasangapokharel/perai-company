            ...
            <div class="max-w-md w-full relative z-10">
                ...
                <form action="" method="post" class="space-y-6">
                    ...
                    <div class="flex items-center">
                        <input id="remember_me" name="remember_me" type="checkbox" class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded-xl">
                        <label for="remember_me" class="ml-2 block text-sm text-gray-700">
                            Remember me
                        </label>
                    </div>
                    
                    <button type="submit" class="w-full flex justify-center py-3.5 px-4 border border-transparent rounded-xl shadow-sm text-sm font-bold text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
                        Sign In
                    </button>
                </form>
                ...
                <p class="mt-8 text-center text-sm text-gray-600">
                    ...
                    <a href="../register/" class="font-bold text-primary-600 hover:text-primary-500">Sign up for free</a>
                </p>
            </div>
        </div>
